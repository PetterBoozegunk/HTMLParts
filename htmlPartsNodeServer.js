    ...
    util = {
        ...
        getInclude: function (rnrObject) {
            ...
            fs.readFile(fullPath, function (error, data) {
                if (error) {
                    include = "<div style=\"color: red; background: #ffe2e7; padding: 5px 10px; border: solid 1px red;\">The file \"" + fullPath + "\" does not exist</div>";
                } else {
                    include = data.toString("utf-8");
                }

                newdata = rnrObject.data.replace(rnrObject.includes[0], include);
                rnrObject.data = newdata;

                util.getIncludes(rnrObject);
            });
        },
